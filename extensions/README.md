...
| 扩展 | 说明 | 文档 |
| --- | --- | --- |
| ming-core | 通用能力编排（模型、会话壳、子 Agent、Dashboard、Pi Lens、Ponytail 等） | [`ming-core/README.md`](ming-core/README.md) |
...
| Ponytail | 懒惰高级工程师模式；转发 bundled `@dietrichgebert/ponytail`，不单独出现在扩展列表 | [`ponytail/README.md`](ponytail/README.md) |
