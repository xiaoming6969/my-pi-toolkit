...
- Tests/lint: there is no root test/lint/build script and no root `tsconfig`. Do not assume `npm test` exists; run the smallest relevant extension checks directly.
